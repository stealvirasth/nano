...
#==============================================================================#
#line = LINE()
line = LINE('Etw3t8W1bAFu7PFLtOK1.qYrMQO4gXpceGGR1gbkR4q.YglAY0TtXf6P+vjulGf09FjeOEz9WPZFZANt3/MAepk=')
line.log("Auth Token : " + str(line.authToken))
line.log("Timeline Token : " + str(line.tl.channelAccessToken))

#ki = LINE()
ki = LINE('EtTx7jUYLuIOomzIXay6./lM9YOrB0Gm+5FZ5CM7pvG.60DxtzmkypHk7CXc5xJ0D3kgqnITkdJfyjsEYSiYxJQ=')
ki.log("Auth Token : " + str(ki.authToken))
ki.log("Timeline Token : " + str(ki.tl.channelAccessToken))

#kk = LINE()
kk = LINE('EtyqGGat9i5RcR6Lejm0.x0+nhacvft0INQIpHi9Tua.s2+6CrUJHP5VOXV5tnpUjT/dwwYs7iZQhSd9cpa8Tvg=')
kk.log("Auth Token : " + str(kk.authToken))
kk.log("Timeline Token : " + str(kk.tl.channelAccessToken))

#kc = LINE()
kc = LINE('EtmccTsZM9cfWZN1FZK9./9D5e+13NIfstiB20Y7u6q.P/jhr/t37FUzl6hU6Z+QsbyIswY8luASLF/8SvDtOWY=')
kc.log("Auth Token : " + str(kc.authToken))
kc.log("Timeline Token : " + str(kc.tl.channelAccessToken))

#ke = LINE()
ke = LINE('EtlfbZ0mpV8Kze5p7kw3.QxkhYgEDbzweDhKdgKHViW.0yk73uAMy+GyR0RTieLTm6D9J0dPhg+IW0xjHPJNNUo=')
...
#==============================================================================#
                ...
                elif text.lower() == 'เปิดเช็คสติ๊ก':
                    settings["checkSticker"] = True
                    line.sendMessage(to, "💙 เปิดเช็คสติ๊กเรียบร้อย..")
                elif text.lower() == 'ปิดเช็คสติ๊ก':
...
# ----------------- NOTIFED MEMBER JOIN GROUP
        if op.type == 17:
          if settings["Wc"] == True:
            ...
            line.sendMessage(op.param1, " ยินดีต้อนรับ. เข้ามาแล้วก็อย่าลืมปิดแจ้งเตือนกันน่ะครับ" + line.getContact(op.param2).displayName + " สู่กลุ่ม " + "👉" + str(ginfo.name) + "👈""\nหรือสนใจลงบอทป้องกันบอทแท็ก ติดต่อได้ที่Line ID : klkl191\nhttp://line.me/ti/p/~klkl191")			
# ----------------- NOTIFED MEMBER OUT GROUP
        if op.type == 15:
          if settings['Lv'] == True:
            if op.param2 in bot1:
                return
            line.sendMessage(op.param1,"good Bye" + line.getContact(op.param2).displayName + "รีบไปไหนอ่ะ. ไม่เป็นไรไว้เจอกันใหม่น่ะจ๊ะ")
# ----------------- NOTIFED MEMBER JOIN GROUP
        if op.type == 55:
            try:
